...
We will cover some concepts of working with the commandline. You can get a full notebook with a intro to commandline in the materials for [Topic 1](%22topics/topic-01.html%22)
...
Check [the intro to quarto notebook](/lecture_notes/week-1/intro_to_quarto.html) on how to use Python in Rstudio. Let's cover some of the installation steps here:
