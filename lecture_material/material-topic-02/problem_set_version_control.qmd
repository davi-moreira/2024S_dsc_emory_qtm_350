...
1. **Setting Up:**
   ...
   - Each group will create a new repository on GitHub.
...
7. **Finalizing the README:**
   - Collaboratively edit the README file in the main branch to include:
     - Project title, description, objectives, and members.
     - Contributions by each member.
     - Challenges faced and how they were overcome.
     - Any references or resources used.

8. **Submission:**
   - Submit the link of the the GitHub repository thorough GradeScope.
...
- Check the additional material in the topic webpage and slides.
