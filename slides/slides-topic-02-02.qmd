...
::: r-stack
*Left:* Command Prompt, *Right:* Bash ![](figs/command-prompt-screenshot.png){fig-align="center" height="300"} ![](figs/bash-screenshot.png){fig-align="center" height="300"} <br> *Left:* C Shell, *Right:* more shells <br> ![](figs/cshell-screenshot.png){fig-align="center" height="250"} ![](figs/seashells.jpeg){fig-align="center" height="250"} <br> Credit [Read-back spider](https://commons.wikimedia.org/wiki/File:Different_types_of_shells.jpg)/[Dave Kerr](https://effective-shell.com/docs/part-2-core-skills/what-is-a-shell/)
:::
:::
