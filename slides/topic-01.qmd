...
knitr::include_graphics("topic-01-figs/davi_moreira_photo.JPG") 
```
...
knitr::include_graphics("topic-01-figs/palmeiras_logo.png") 
```

```{r  echo=FALSE, out.width = "60%", fig.align="center"}
knitr::include_graphics("topic-01-figs/palmeiras_stadium.jpg") 
```

## Instructor's Passions

```{r  echo=FALSE, out.width = "35%", fig.align="center"}
knitr::include_graphics("topic-01-figs/carnaval_olinda.jpg") 
```
...
knitr::include_graphics("topic-01-figs/digital.jpeg") 
```
...
```{r  echo=FALSE, out.width = "20%", fig.align="center"}
knitr::include_graphics("topic-01-figs/redes.png") 
```
...
knitr::include_graphics("topic-01-figs/tweets.png") 
```
:::

::: {.column width="50%"}
```{r  echo=FALSE, out.width = "100%",fig.align="center"}
knitr::include_graphics("topic-01-figs/imagescnn.png") 
```
:::
:::
...
knitr::include_graphics("topic-01-figs/survey.png") 
```

## Powerful and Cheap Computer Power

```{r  echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics("topic-01-figs/collab.png") 
```
...
-   **Materials**: 
    ...
    -   [https://davi-moreira.github.io/2024S_dsc_emory_qtm_350/](https://davi-moreira.github.io/2024S_dsc_emory_qtm_350/)
...
-   We gain power learning how to use the Command line
