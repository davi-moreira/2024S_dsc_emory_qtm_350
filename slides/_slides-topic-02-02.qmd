...
<center>![](figs/teletype.jpg){fig-align="right" height="150"}
![](figs/image-ibm3486.jpeg){fig-align="right" height="150"}</center>
...
![](figs/command-prompt-screenshot.png){fig-align="center" height="300"}
![](figs/bash-screenshot.png){fig-align="center" height="300"}
<br>
*Left:* C Shell, *Right:* more shells
<br>
![](figs/cshell-screenshot.png){fig-align="center" height="250"}
![](figs/seashells.jpeg){fig-align="center" height="250"}
<br>
...
<br>
<center>![](figs/windows31-screenshot.png){fig-align="center" height="250"}
![](figs/windows11-screenshot.jpg){fig-align="center" height="250"}

![](figs/macos8-screenshot.png){fig-align="center" height="250"}
![](figs/macos-finder-screenshot.jpeg){fig-align="center" height="250"}</center>
...
![](figs/expanding-brain.jpg){fig-align="center" height="600"}
...
<center>For a more detailed overview, click [here](https://effective-shell.com/docs/part-1-transitioning-to-the-shell/navigating-your-system/).</center>
...
As another example, let's change _all_ of the file names in the `slides-topic-02-02-examples/meals` directory.
...
For a more detailed overview, click [here](https://effective-shell.com/docs/part-1-transitioning-to-the-shell/managing-your-files/).
...
![](figs/bookshelf.gif){fig-align="center" height="500"}
...
For a more detailed overview, click [here](https://effective-shell.com/docs/part-3-manipulating-text/).
